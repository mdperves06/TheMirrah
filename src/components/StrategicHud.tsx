      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="hidden sm:flex items-center gap-1.5 text-[11px] text-parchment-300">
            <span className="font-mono text-parchment-400">Territory:</span>
          ...
          <div className="hidden md:flex items-center gap-1 text-[11px] text-red-400 font-mono">
            ...
            <span>The Seam: Contested Standoff</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span>Suni Wells: {suniWellsStatus === 'restricted' ? 'Encircled (Siege)' : 'Relief Monitored'}</span>
          </div>
          ...
          <div className="hidden xl:flex items-center gap-1 px-2 py-0.5 rounded bg-red-950/40 text-red-400 border border-red-500/30 text-[10px] font-mono">
            ...
            <span>Ashen Threat: HIGH (6 Cells)</span>
          </div>
          ...
          <div className="flex items-center gap-1 px-2 py-0.5 rounded bg-parchment-900 text-amber-300 border border-parchment-400/20 text-[10px] font-mono">
            ...
            <span>Sanctions: {activeSanctionsCount} Active</span>
          </div>
      ...
      {!collapsed && (
        <div className="mt-1.5 pt-1.5 border-t border-parchment-400/10 grid grid-cols-2 md:grid-cols-4 gap-2 text-[10px] text-parchment-300 font-sans animate-in slide-in-from-top-1 duration-200">
          <div className="flex items-center gap-1.5">
            ...
            <span>Active Seat: <strong className="text-parchment-100 uppercase">{playerSeat}</strong></span>
          </div>
          <div className="flex items-center gap-1.5">
            <AlertTriangle className="w-3 h-3 text-amber-400" />
            <span>Core Grievance: <strong className="text-parchment-100">Cancelled Referendum (~14y)</strong></span>
          </div>
          <div className="flex items-center gap-1.5">
            <Compass className="w-3 h-3 text-sky-400" />
            <span>Energy Link: <strong className="text-parchment-100">Veridium (North) & Duskore (South)</strong></span>
          </div>
          <div className="flex items-center gap-1.5">
            <TrendingUp className="w-3 h-3 text-emerald-400" />
            <span>Talks Stability: <strong className="text-parchment-100">3-Day Breakdown Risk</strong></span>
          </div>
        </div>
      )}
    </div>
